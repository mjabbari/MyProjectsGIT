...
static void native_to_managed_trampoline_10 (id self, SEL _cmd, MonoMethod **managed_method_ptr, double p0, const char *r0, const char *r1, const char *r2)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [1];
	MonoObject *mthis;
...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "TinyLand.AppDelegate, TinyLand", "get_Window");
	}

	-(void) setWindow:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIWindow, Xamarin.iOS", "TinyLand.AppDelegate, TinyLand", "set_Window");
	}

	-(BOOL) application:(id)p0 didFinishLaunchingWithOptions:(id)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "TinyLand.AppDelegate, TinyLand", "FinishedLaunching");
	}

	-(void) applicationWillResignActive:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "TinyLand.AppDelegate, TinyLand", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "TinyLand.AppDelegate, TinyLand", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "TinyLand.AppDelegate, TinyLand", "WillEnterForeground");
	}

	-(void) applicationDidBecomeActive:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "TinyLand.AppDelegate, TinyLand", "OnActivated");
	}

	-(void) applicationWillTerminate:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "TinyLand.AppDelegate, TinyLand", "WillTerminate");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_6 (self, _cmd, &managed_method, "TinyLand.AppDelegate, TinyLand", ".ctor");
	}
@end
...
@implementation GameViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "TinyLand.GameViewController, TinyLand", "ViewDidLoad");
	}

	-(BOOL) shouldAutorotate
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, "TinyLand.GameViewController, TinyLand", "ShouldAutorotate");
	}

	-(NSUInteger) supportedInterfaceOrientations
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_8 (self, _cmd, &managed_method, "TinyLand.GameViewController, TinyLand", "GetSupportedInterfaceOrientations");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "TinyLand.GameViewController, TinyLand", "DidReceiveMemoryWarning");
	}

	-(BOOL) prefersStatusBarHidden
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, "TinyLand.GameViewController, TinyLand", "PrefersStatusBarHidden");
	}
...
@interface TinyLand_GameScene : SKScene {
	XamarinObject __monoObjectGCHandle;
}
	-(void) release;
	-(id) retain;
	...
	-(BOOL) conformsToProtocol:(void *)p0;
@end
@implementation TinyLand_GameScene { } 
	-(void) release
	{
		xamarin_release_trampoline (self, _cmd);
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "SpriteKit.SKView, Xamarin.iOS", "TinyLand.GameScene, TinyLand", "DidMoveToView");
	}

	-(void) didSimulatePhysics
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "TinyLand.GameScene, TinyLand", "DidSimulatePhysics");
	}

	-(void) touchesBegan:(id)p0 withEvent:(id)p1
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, p1, "Foundation.NSSet, Xamarin.iOS", "UIKit.UIEvent, Xamarin.iOS", "TinyLand.GameScene, TinyLand", "TouchesBegan");
	}

	-(void) update:(double)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, "System.Double, mscorlib", "TinyLand.GameScene, TinyLand", "Update");
	}
...
@interface TinyLand_Character : SKSpriteNode {
	XamarinObject __monoObjectGCHandle;
}
	-(void) release;
	-(id) retain;
	...
	-(id) init;
@end
@implementation TinyLand_Character { } 
	-(void) release
	{
		xamarin_release_trampoline (self, _cmd);
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_6 (self, _cmd, &managed_method, "TinyLand.Character, TinyLand", ".ctor");
	}
@end

@interface TinyLand_Platforms : SKSpriteNode {
	XamarinObject __monoObjectGCHandle;
}
	-(void) release;
	-(id) retain;
	...
	-(BOOL) conformsToProtocol:(void *)p0;
@end
@implementation TinyLand_Platforms { } 
	-(void) release
	{
		xamarin_release_trampoline (self, _cmd);
	}
...
@interface TinyLand_BgSprite : SKSpriteNode {
	XamarinObject __monoObjectGCHandle;
}
	-(void) release;
	-(id) retain;
	...
	-(BOOL) conformsToProtocol:(void *)p0;
@end
@implementation TinyLand_BgSprite { } 
	-(void) release
	{
		xamarin_release_trampoline (self, _cmd);
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"SKTexture", "SpriteKit.SKTexture, Xamarin.iOS", NULL },
		{"SKAction", "SpriteKit.SKAction, Xamarin.iOS", NULL },
		{"SKPhysicsBody", "SpriteKit.SKPhysicsBody, Xamarin.iOS", NULL },
		...
		{"AppDelegate", "TinyLand.AppDelegate, TinyLand", NULL },
		{"GameViewController", "TinyLand.GameViewController, TinyLand", NULL },
		{"TinyLand_GameScene", "TinyLand.GameScene, TinyLand", NULL },
		{"TinyLand_Character", "TinyLand.Character, TinyLand", NULL },
		{"TinyLand_Platforms", "TinyLand.Platforms, TinyLand", NULL },
		{"TinyLand_BgSprite", "TinyLand.BgSprite, TinyLand", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [10].handle = objc_getClass ("SKLabelNode");
	...
	__xamarin_class_map [14].handle = objc_getClass ("SKView");
	__xamarin_class_map [15].handle = objc_getClass ("SKTexture");
	__xamarin_class_map [16].handle = objc_getClass ("SKAction");
	__xamarin_class_map [17].handle = objc_getClass ("SKPhysicsBody");
	...
	__xamarin_class_map [42].handle = [GameViewController class];
	__xamarin_class_map [43].handle = [TinyLand_GameScene class];
	__xamarin_class_map [44].handle = [TinyLand_Character class];
	__xamarin_class_map [45].handle = [TinyLand_Platforms class];
	__xamarin_class_map [46].handle = [TinyLand_BgSprite class];
